...
public class playerVSAIGame {
	...
	public String getResult() {
		result = currentBoard.checkResult();
		if (result == 0) {
			if (playerTurn == 1) return "Player moves";
			else return "AI moves";
